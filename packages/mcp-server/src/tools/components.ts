  ...
  const defs: BridgeToolDef[] = [
    opTool('create_component', {
      ...
      followUp: {
        ...
        description: 'createComponent.description2',
      },
    }),
    ...
    opTool('detach_instance', {
      ...
      followUp: {
        ...
        description: 'detachInstance.description',
      },
    }),
    ...
    opTool('swap_component', {
      ...
      followUp: {
        type: 'tool',
        tool: 'jsd_set_instance_properties',
        description: 'swapComponent.description',
      },
    }),
    opTool('set_instance_properties', {
      ...
      followUp: {
        ...
        description: 'setInstanceProperties.description',
      },
    }),
    opTool('combine_as_variants', {
      name: 'jsd_combine_as_variants',
      title: 'combineAsVariants.title',
      description:
    ...
    opTool('apply_overrides', {
      ...
      followUp: {
        type: 'tool',
        tool: 'jsd_sync_overrides',
        description: 'applyOverrides.description',
      },
    }),
    opTool('sync_overrides', {
      name: 'jsd_sync_overrides',
      title: 'syncOverrides.title',
      description:
      ...
      followUp: {
        ...
        description: 'syncOverrides.description',
      },
    }),
  ];
