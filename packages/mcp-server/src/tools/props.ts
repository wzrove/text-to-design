...
export function registerPropTools(
  ...
  const defs = [
    propUpdateTool({
      ...
      description: i18n.t('setFillColor.description', {
        warn: INSTANCE_STYLE_WARN,
      }),
      method: 'set_fill',
      ...
      followUp: {
        type: 'tool',
        tool: 'jsd_set_stroke',
        description: 'setFillColor.followUp',
      },
    }),
    propUpdateTool({
      name: 'jsd_set_stroke',
      title: 'setStroke.title',
      description:
      ...
      followUp: {
        ...
        description: 'setStroke.description',
      },
    }),
    propUpdateTool({
      name: 'jsd_set_cornerRadius',
      title: 'setCornerRadius.title',
      description:
      ...
      followUp: {
        ...
        description: 'setCornerRadius.description',
      },
    }),
    propUpdateTool({
      name: 'jsd_set_text',
      title: 'setText.title',
      description: i18n.t('setText.description', { warn: INSTANCE_STYLE_WARN }),
      method: 'set_text',
      ...
      followUp: {
        ...
        description: 'setText.followUp',
      },
    }),
    propUpdateTool({
      name: 'jsd_move_node',
      title: 'moveNode.title',
      description:
    ...
    propUpdateTool({
      ...
      followUp: {
        ...
        description: 'resizeNode.description',
      },
    }),
    propUpdateTool({
      name: 'jsd_set_layout',
      ...
      followUp: {
        ...
        description: 'setLayout.description',
      },
    }),
    propUpdateTool({
      name: 'jsd_set_effects',
      title: 'setEffects.title',
      description:
      ...
      followUp: {
        type: 'tool',
        tool: 'jsd_set_visibility',
        description: 'setEffects.description',
      },
    }),
    propUpdateTool({
      ...
      followUp: {
        ...
        description: 'setVisibility.description',
      },
    }),
    propUpdateTool({
      name: 'jsd_rename_node',
      title: 'renameNode.title',
      description:
      ...
      followUp: {
        type: 'tool',
        tool: 'jsd_set_text',
        description: 'renameNode.description',
      },
    }),
    propUpdateTool({
      name: 'jsd_set_shape',
      ...
      followUp: {
        type: 'tool',
        tool: 'jsd_set_fill_color',
        description: 'setShape.description',
      },
    }),
  ];
